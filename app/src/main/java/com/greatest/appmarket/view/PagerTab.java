package com.greatest.appmarket.view;
...
import com.greatest.appmarket.activity.BaseActivity;
...
public class PagerTab extends ViewGroup {
	...
	private int mDividerPadding = 10;// 分割线上下的padding
	...
	private int mTabPadding = 22;// tab左右的内边距
